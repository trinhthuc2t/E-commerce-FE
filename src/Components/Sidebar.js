...
import {MdOutlineChangeCircle, MdOutlineCircleNotifications, MdStorefront} from "react-icons/md";
    ...
    return (
        <div className='col-3 position-fixed ps-5'>
            <div className='border rounded-5 bg-light' style={{height: 700}}>
                <ul className='text-24 mt-3 ms-0'>
                    <ol>
                        <FaRegUser className='text-color me-3 mb-2'/>
                        <Link to={`information`} className='text-decoration-none'>Thông tin cá nhân</Link>
                    </ol>
                    <ol>
